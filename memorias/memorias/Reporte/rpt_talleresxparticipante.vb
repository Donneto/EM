...
Public Class rpt_talleresxparticipante
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_talleresxparticipante.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_talleresxparticipante
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_talleresxparticipante = New rpt_talleresxparticipante
        rpt.Site = Me.Site
        Return rpt
    End Function
