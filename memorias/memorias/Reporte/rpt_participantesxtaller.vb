...
Public Class rpt_participantesxtaller
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_participantesxtaller.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_participantesxtaller
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_participantesxtaller = New rpt_participantesxtaller
        rpt.Site = Me.Site
        Return rpt
    End Function
