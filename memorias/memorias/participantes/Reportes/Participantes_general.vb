...
Public Class Participantes_general
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Participantes_general.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedParticipantes_general
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Participantes_general = New Participantes_general
        rpt.Site = Me.Site
        Return rpt
    End Function
